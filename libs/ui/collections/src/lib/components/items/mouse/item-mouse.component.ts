...
import { MouseData } from '@show-off/api-interfaces';
import {
  DataListComponent,
  DataListData,
  TypeIconPipe,
...
export class ItemMouseComponent extends ItemDisplayBaseClass<MouseData> {
  getDataList(data: MouseData): DataListData[] {
    return [
      {
        label: 'Make',
        value: data.make,
