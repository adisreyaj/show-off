...
import { SupportedItemTypes, WebcamData } from '@show-off/api-interfaces';
...
@Component({
  selector: 'show-off-item-microphone-form',
...
export class ItemWebcamFormComponent extends ItemFormBase<WebcamData> {
